...
(define (lambda-exp var lcexp) (list 'lambda var lcexp))
...
(define (lambda-exp? lcexp)
  (match lcexp
    ((list operator identifier lc-exp)
...
(define (lambda-exp->bound-var lc-exp)
  (match lc-exp
    ((list operator identifier exp) identifier)))

(define (lambda-exp->body lc-exp)
  (match lc-exp
    ((list operator identifier exp) exp)))
